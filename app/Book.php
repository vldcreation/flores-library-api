...
class Book extends Model
{
    ...
    public $table = "book";
    protected $fillable = [
        'id_kategori', 'barcode', 'isbn', 'judul', 'deskripsi', 'penulis', 'penerbit', 'gambar_buku', 'path_gambar', 'file_buku', 'path_file', 'bahasa', 'edisi', 'tahun_terbit', 'subject', 'lokasi','url', 'isavailable'
    ];
